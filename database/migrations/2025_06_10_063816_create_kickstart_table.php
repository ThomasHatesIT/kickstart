...
return new class extends Migration
{
    ...
    {
        // Users table (roles managed by Spatie)
        ...
        // Products table with approval flow and stock management
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->json('sizes')->nullable(); // JSON array of available sizes
        ...
        // Password reset tokens table (Laravel 9)
